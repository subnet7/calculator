...
button_additon = Button(root, text = "+", padx=40, pady=20, command=button_plus)
button_equal = Button(root, text = "=", padx =40, pady=20, command=button_eq)
button_clr = Button(root, text="C", padx=40, pady=20, command=button_clear)
